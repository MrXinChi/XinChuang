		...
		<div class="kecheng">
			<div v-for="i in dataList" :key="i" class="kecheng-item">
				<div class="kecheng-item-t flex flex_x_bten">
					<div class="item_left flex flex_x_bten">
						<div class="kecheng-item-t-l fs15 fw_b">星期一:{{i}}</div>
						<div class="kecheng-item-t-r fs15">17:00</div>
					</div>
					<div class="item_right">
						<van-icon @click="deleteItem(i)" name="cross" color="red" size="30" />
					</div>
				</div>
