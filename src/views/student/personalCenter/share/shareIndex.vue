...
.container_ {
  ...
  background: #f3f4f5;
  .header_right {
    @include icon(30, "../../../../assets/student/personalCenter/icon_three_points.png");
  }
  .top_wrapper {
    width: 100vw;
    height: 59vw;
    background-image: url("../../../../assets/student/personalCenter/back_img2.png");
    ...
    .score_wrapper {
      ...
      .score_btn {
        ...
        box-shadow: 0px 3px 0px 0px rgba(148, 209, 207, 1);
        border-radius: 11px;
      }
      .score_title {
        @include word(13, #ffffff);
